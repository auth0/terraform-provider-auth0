...
func New() *schema.Provider {
	provider := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"auth0_organization_client":                      organization.NewClientResource(),
			"auth0_organization_clients":                     organization.NewClientsResource(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"auth0_client_grant_organizations":               client.NewClientGrantOrganizationsDataSource(),
			...
			"auth0_organization_client":                      organization.NewClientDataSource(),
			...
			"auth0_user_organizations":                       user.NewOrganizationsDataSource(),
