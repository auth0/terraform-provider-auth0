		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("auth0_connection.my_connection", "authentication.active", "true"),
					resource.TestCheckResourceAttr("auth0_connection.my_connection", "connected_accounts.active", "true"),
