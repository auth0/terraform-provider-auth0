		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("auth0_custom_domain.my_custom_domain", "verification.0.methods.#", "1"),
					resource.TestCheckResourceAttr("auth0_custom_domain.my_custom_domain", "verification.0.methods.0.name", "TXT"),
					resource.TestCheckResourceAttrSet("auth0_custom_domain.my_custom_domain", "verification.0.methods.0.record"),
					resource.TestCheckResourceAttr("auth0_custom_domain.my_custom_domain", "verification.0.methods.0.domain", fmt.Sprintf("_cf-custom-hostname.%s.auth.tempdomain.com", strings.ToLower(t.Name()))),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("auth0_custom_domain.my_custom_domain", "verification.#", "1"),
					resource.TestCheckResourceAttr("auth0_custom_domain.my_custom_domain", "verification.0.methods.#", "1"),
					resource.TestCheckResourceAttr("auth0_custom_domain.my_custom_domain", "verification.0.methods.0.name", "CNAME"),
					resource.TestCheckResourceAttrSet("auth0_custom_domain.my_custom_domain", "verification.0.methods.0.record"),
					resource.TestCheckResourceAttr("auth0_custom_domain.my_custom_domain", "verification.0.methods.0.domain", fmt.Sprintf("%s.auth.tempdomain.com", strings.ToLower(t.Name()))),
					resource.TestCheckResourceAttr("auth0_custom_domain.my_custom_domain", "custom_client_ip_header", ""),
