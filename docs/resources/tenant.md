...
- `require_pushed_authorization_requests` (Boolean, Deprecated) DEPRECATED: This Flag is not supported by the Auth0 Management API and will be removed in the next major release.
