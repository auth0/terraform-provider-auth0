...
- `authentication` (List of Object) Configuration settings for connection authentication. (see [below for nested schema](#nestedatt--authentication))
- `connected_accounts` (List of Object) Configurations settings for the connections connected accounts. (see [below for nested schema](#nestedatt--connected_accounts))
