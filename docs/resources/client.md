...
- `azure_blob` (Map of String, Deprecated)
- `azure_sb` (Map of String, Deprecated)
- `box` (Map of String, Deprecated)
- `cloudbees` (Map of String, Deprecated)
- `concur` (Map of String, Deprecated)
- `dropbox` (Map of String, Deprecated)
- `echosign` (Map of String, Deprecated)
- `egnyte` (Map of String, Deprecated)
- `firebase` (Map of String, Deprecated)
- `layer` (Map of String, Deprecated)
- `mscrm` (Map of String, Deprecated)
- `newrelic` (Map of String, Deprecated)
- `office365` (Map of String, Deprecated)
- `rms` (Map of String, Deprecated)
- `salesforce` (Map of String, Deprecated)
- `salesforce_api` (Map of String, Deprecated)
- `salesforce_sandbox_api` (Map of String, Deprecated)
- `samlp` (Block List, Max: 1) Configuration settings for a SAML add-on. (see [below for nested schema](#nestedblock--addons--samlp))
- `sap_api` (Map of String, Deprecated)
- `sentry` (Map of String, Deprecated)
- `sharepoint` (Map of String, Deprecated)
- `slack` (Map of String, Deprecated)
- `springcm` (Map of String, Deprecated)
- `wams` (Map of String, Deprecated)
...
- `zendesk` (Map of String, Deprecated)
- `zoom` (Map of String, Deprecated)
